...
public class UserGroupMenuController {
    ...
    public AjaxResult saveUserGroupMenus(
		...
		System.out.println(strUserGroupMenuList);
		System.out.println("메뉴권한 저장 들어옴");
		AjaxResult result = new AjaxResult();
		...
		userGroupMenuList.forEach(map->{
			...
			if(ugm_id==null) {
				//insert
				String sql= """
					INSERT INTO [#user_group_menu2] ([UserGroup_id], [MenuCode], [AuthCode], [_creater_id], [_created])
					VALUES (:group_id, :auth_code, :user_id, GETDATE())
					""";
				System.out.println("Executing SQL: " + sql);
				System.out.println("SQL Parameters: " + dicParam.getValues());
				System.out.println("SQL Parameters: " + dicParam.getValues());
